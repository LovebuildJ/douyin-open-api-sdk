...
public class ToutiaoVideoListApi {
     ...
     */
    public ToutiaoVideoListVideoListInlineResponse200 toutiaoVideoListGet(String openId, String accessToken, Integer count, Long cursor) throws RestClientException {
