...
import com.douyin.open.models.EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-08-13T12:07:54.918268+08:00[Asia/Shanghai]")
@JsonSerialize(include = JsonSerialize.Inclusion.NON_NULL)
public class EnterpriseGrouponGrouponGrouponListGrouponItem {
  ...
  private List<EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods> grouponGoods = new ArrayList<>();
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem grouponId(String grouponId) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem useType(UseTypeEnum useType) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem codeType(CodeTypeEnum codeType) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem merchantName(String merchantName) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem serviceNumber(String serviceNumber) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem coverImages(List<String> coverImages) {
    this.coverImages = coverImages;
    return this;
  }

  public EnterpriseGrouponGrouponGrouponListGrouponItem addCoverImagesItem(String coverImagesItem) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem originalAmount(Integer originalAmount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem actualAmount(Integer actualAmount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem notification(String notification) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem orderLimit(Integer orderLimit) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem stock(Integer stock) {
    this.stock = stock;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem poiIds(List<String> poiIds) {
    this.poiIds = poiIds;
    return this;
  }

  public EnterpriseGrouponGrouponGrouponListGrouponItem addPoiIdsItem(String poiIdsItem) {
    if (this.poiIds == null) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem grouponGoods(List<EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods> grouponGoods) {
    this.grouponGoods = grouponGoods;
    return this;
  }

  public EnterpriseGrouponGrouponGrouponListGrouponItem addGrouponGoodsItem(EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods grouponGoodsItem) {
  ...
  **/
  ...
  public List<EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods> getGrouponGoods() {
    return grouponGoods;
  }

  public void setGrouponGoods(List<EnterpriseGrouponGrouponGrouponListGrouponItemGrouponGoods> grouponGoods) {
    this.grouponGoods = grouponGoods;
  }

  public EnterpriseGrouponGrouponGrouponListGrouponItem startTime(Long startTime) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem endTime(Long endTime) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem h5Url(String h5Url) {
    this.h5Url = h5Url;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem soldCount(Integer soldCount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponGrouponListGrouponItem auditMsg(String auditMsg) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseGrouponGrouponGrouponListGrouponItem grouponItem = (EnterpriseGrouponGrouponGrouponListGrouponItem) o;
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseGrouponGrouponGrouponListGrouponItem {\n");
