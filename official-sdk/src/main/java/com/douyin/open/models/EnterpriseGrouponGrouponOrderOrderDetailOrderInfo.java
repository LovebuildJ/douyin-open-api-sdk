...
import com.douyin.open.models.EnterpriseGrouponGrouponOrderOrderDetailCodeInfo;
...
public class EnterpriseGrouponGrouponOrderOrderDetailOrderInfo {
  ...
  @JsonProperty("codes")
  private List<EnterpriseGrouponGrouponOrderOrderDetailCodeInfo> codes = new ArrayList<>();

  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo orderId(String orderId) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo channel(String channel) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo buyerOpenId(String buyerOpenId) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo originalAmount(Integer originalAmount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo amount(Integer amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo refundAmount(Integer refundAmount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo settleAmount(Integer settleAmount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo itemCount(Integer itemCount) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo createTime(Long createTime) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo payTime(Long payTime) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo refundTime(Long refundTime) {
  ...
  **/
  ...
  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo codes(List<EnterpriseGrouponGrouponOrderOrderDetailCodeInfo> codes) {
    this.codes = codes;
    return this;
  }

  public EnterpriseGrouponGrouponOrderOrderDetailOrderInfo addCodesItem(EnterpriseGrouponGrouponOrderOrderDetailCodeInfo codesItem) {
  ...
  **/
  ...
  public List<EnterpriseGrouponGrouponOrderOrderDetailCodeInfo> getCodes() {
    return codes;
  }

  public void setCodes(List<EnterpriseGrouponGrouponOrderOrderDetailCodeInfo> codes) {
    this.codes = codes;
  }
  ...
  public boolean equals(Object o) {
    ...
    EnterpriseGrouponGrouponOrderOrderDetailOrderInfo orderInfo = (EnterpriseGrouponGrouponOrderOrderDetailOrderInfo) o;
  ...
  public String toString() {
    ...
    sb.append("class EnterpriseGrouponGrouponOrderOrderDetailOrderInfo {\n");
